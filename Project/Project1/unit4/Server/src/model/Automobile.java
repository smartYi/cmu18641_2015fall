...
public class Automobile implements Serializable{
	...
	//Each model should have a car make
	 ...
	 * @param basePrice
	 */
	public Automobile(String carmake, String model, int size, float basePrice) {
		this.model = model;
		this.carMake = carmake;
		this.basePrice = basePrice;
		optionSets = new ArrayList<>();
	...
	/**
	 * Set option name, price with its optionset name and option index.
	 * @param setName
	 * @param optionName
	 * @param price
	 */
	public void setOptionValue(String setName, String optionName, float price) {
